...
function removeClasslistFromInputDivRedBorderLogIn() {
  document
    .getElementById("inputDivRedBorderLogInPassword")
    .classList.remove("check-password-red-border");
  document
    .getElementById("inputDivRedBorderLogInEmail")
    .classList.remove("check-password-red-border");
}
...
function setPasswordAlertLogIn(passwordErrorDiv) {
  ...
  document
    .getElementById("inputDivRedBorderLogInPassword")
    .classList.add("check-password-red-border");
}
...
// async function userSignUp() {
//   let {emailErrorDiv, passwordErrorDiv, emailToSearch, checkbox, checkboxErrorDiv,
//   } = setVariablesForSignUp();
//   removeRedBorderClassList();
//   emptyErrorDivText(emailErrorDiv, passwordErrorDiv);
 ...
 */
async function succesSignUp(passwordErrorDiv, emailErrorDiv) {
...
function removeRedBorderClassList() {
  document
    .getElementById("inputEmailDivRedBorderSignUp")
    .classList.remove("check-password-red-border");
  document
    .getElementById("inputPasswordDivRedBorderSignUp")
    .classList.remove("check-password-red-border");
}
